...
window.addEventListener('scroll', function() {
    if (window.scrollY > 100) {
        navbar.style.background = 'rgba(59, 60, 61, 0.98)';
        navbar.style.boxShadow = '0 4px 20px rgba(162, 137, 108, 0.2)';
    } else {
        navbar.style.background = 'rgba(59, 60, 61, 0.95)';
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Portafolio de Maira Alejandra Guevara Rizzo cargado exitosamente! 🚀');
